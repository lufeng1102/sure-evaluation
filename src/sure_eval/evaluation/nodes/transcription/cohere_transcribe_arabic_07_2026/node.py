...
def build(*, runner=None, **config):
    """Build a transcription node factory around :func:`transcribe_cohere_transcribe_arabic_07_2026`."""

    def node(audio_path: str, *, language: str = "ar", role: str = "prediction_audio"):
